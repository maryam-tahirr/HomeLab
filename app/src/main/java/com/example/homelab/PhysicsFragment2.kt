...
class PhysicsFragment2 : Fragment(), ExperimentAdapter.OnItemClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_physics2, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView = view.findViewById(R.id.physrecycle2) // Ensure the ID is correct
        ...
        experiments.add(
            Experiment(
                ...
                R.drawable.electricmotor,
                "Build a basic electric motor to learn about electromagnetism",
                listOf("Copper wire", "AA battery", "Magnet","Paper Clips"),
                listOf("Create a coil with copper wire.", "Attach paper clips to the battery terminals.", "Place the coil on the paper clips and hold the magnet nearby","4.\tObserve the coil spinning, forming a simple motor"),
                "https://www.youtube.com/embed/WI0pGk0MMhg?si=zwZakRs2bwJ5QcTg"
            )
        )
        experiments.add(
            Experiment(
                "Investigating Refraction",
                R.drawable.refraction,
                "Explore how light bends when passing through different mediums",
                listOf("Glass of water", "Pencil", "Laser Pointer"),
                listOf("Place a pencil in a glass of water and observe the bending.", "Shine a laser pointer through the water and observe the light path.", "Compare the behavior of light in air and water."),
                "https://www.youtube.com/embed/m9cUy6B--xc?si=ghVzZZ2sbNGVZ1ru"
            )
        )
