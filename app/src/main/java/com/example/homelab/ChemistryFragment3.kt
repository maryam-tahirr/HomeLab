...
class ChemistryFragment3 : Fragment() , ExperimentAdapter.OnItemClickListener{
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_chemistry3, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView = view.findViewById(R.id.chemrecycle3) // Ensure the ID is correct
        ...
        experiments.add(
            Experiment(
                "Redox Reactions with Potassium Permanganate",
                R.drawable.redox,
                ": Explore redox reactions using potassium permanganate and various reagents",
                listOf("Potassium permanganate", "Hydrogen peroxide", "Sulfuric acid","Beaker"),
                listOf("Mix potassium permanganate with hydrogen peroxide in a beaker", "Observe the color change as the reaction occurs", "Add sulfuric acid and note further changes"),
                "https://www.youtube.com/embed/ZyzfnAkyBlw?si=AdSmlItoMGURnuLV"
            )
        )
        experiments.add(
            Experiment(
                ...
                "Perform a titration to determine the concentration of an acid or base",
                listOf("Hydrochloric acid", "Sodium hydroxide", "Phenolphthalein indicator","Burette","Flask"),
                listOf("Fill the burette with sodium hydroxide", "Add hydrochloric acid to the flask with phenolphthalein", "Slowly add sodium hydroxide to the acid until the solution changes color."),
                "https://www.youtube.com/embed/sFpFCPTDv2w?si=eEI-jhvUNvQsipMx"
            )
        )
